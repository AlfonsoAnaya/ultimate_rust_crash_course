...
fn main() {
    ...
    //
    // - Make a ding_machinerary file (src/ding_machine.rs)
    // - Move all the functions (except main) into the ding_machinerary
    // - Make all the functions public with `pub`
    // - Bring all the functions into scope using use statements. Remember, the name of the ding_machinerary
